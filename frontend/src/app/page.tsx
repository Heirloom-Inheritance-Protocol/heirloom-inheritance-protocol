      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <p className="mx-auto max-w-2xl text-center text-lg text-neutral-600 dark:text-neutral-400">
            Record who passed knowledge to whom on-chain, preserving verifiable lineage. 
          ...
          <div className="mt-20 grid gap-12 md:grid-cols-12">
            <div className="space-y-6 md:col-span-5">
              ...
              <p className="text-neutral-600 dark:text-neutral-400">
                Traditional craftsmanship disappears because knowledge transmission is invisible to institutions. 
                Anchoring successions on-chain with auditable records makes cultural inheritance visible and preservable, 
                protecting historically sensitive knowledge from censorship or alteration.
              </p>
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <Card className="overflow-hidden bg-white dark:bg-neutral-900/50 border-neutral-200 dark:border-neutral-800">
              ...
              <div className="p-6 space-y-3">
                ...
                <p className="text-neutral-600 dark:text-neutral-400">
                  Secret family recipes documented with precise measurements and techniques, passed down through encrypted files while preserving culinary heritage.
                </p>
            ...
            <Card className="overflow-hidden bg-white dark:bg-neutral-900/50 border-neutral-200 dark:border-neutral-800">
              ...
              <div className="p-6 space-y-3">
                ...
                <p className="text-neutral-600 dark:text-neutral-400">
                  Indigenous communities document ancestral stories, medicinal formulas, and ceremonial practices in written form for secure transmission to next generations.
                </p>
                <div className="pt-3 space-y-2">
                  <div className="flex items-center gap-2 text-sm text-neutral-500 dark:text-neutral-400">
            ...
            <Card className="overflow-hidden bg-white dark:bg-neutral-900/50 border-neutral-200 dark:border-neutral-800">
              ...
              <div className="p-6 space-y-3">
                ...
                <p className="text-neutral-600 dark:text-neutral-400">
                  Museums preserve restoration manuals, provenance records, and traditional technique documentation through verifiable custodian succession chains.
                </p>
                <div className="pt-3 space-y-2">
                  <div className="flex items-center gap-2 text-sm text-neutral-500 dark:text-neutral-400">
                    <div className="w-1.5 h-1.5 rounded-full bg-blue-500"></div>
          ...
          <Card className="p-6 bg-gradient-to-r from-neutral-100 to-neutral-50 dark:from-neutral-800/50 dark:to-neutral-900/50 border-neutral-200 dark:border-neutral-800 mt-8">
            <p className="text-center text-base md:text-lg text-neutral-700 dark:text-neutral-300">
              All knowledge is <strong className="text-neutral-900 dark:text-white">documented in encrypted files</strong> with <strong className="text-neutral-900 dark:text-white">verifiable lineage</strong>, enabling sustainable cultural preservation through written records
            </p>
          </Card>
        </div>
      </section>
